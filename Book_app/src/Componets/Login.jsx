  ...
  return (
    ...
    <div className="bg-white p-8 rounded shadow-lg w-96 text-center">
      ...
      <form className="space-y-4">
        ...
        <div>
        <button type="submit" className="w-10px  bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50 " ><Link to="/home">Login Now</Link></button>
        </div>
      </form>
